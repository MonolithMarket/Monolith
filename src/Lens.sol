...
contract Lens {
        ...
        returns (uint256 coinIn, uint256 amountOut)
    {
        ...
        uint256 internalCollateral = _lender.collateralBalances(borrower);
        if (internalCollateral == 0) return (0, 0);
        ...
        uint256 maxRedeemByCollateral = internalCollateral * price * 10000 / 1e18 / (10000 - redeemFeeBps);
        ...
        if (internalAmountOut == 0 || internalAmountOut > internalCollateral) return (0, 0);
